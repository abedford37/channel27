// ============================================================
// CHANNEL 27 — COMMERCIAL LIBRARY
// ============================================================
// Contributors: add commercials here. Each runs ~20-30 seconds.
// kind: toy | cereal | gadget | game | local | infomercial |
//       psa | seasonal | school | food
// lines: shown one at a time, big and loud.
// fine: fine print gag shown at the bottom.
// ============================================================

window.C27 = window.C27 || {};

window.C27.COMMERCIALS = [
  {
    id: "remote-remote",
    kind: "gadget",
    product: "THE REMOTE REMOTE",
    tagline: "The remote that finds your other remote!",
    palette: ["#1E3D8A", "#FFE45E"],
    lines: [
      "Lost the remote AGAIN?",
      "Press the big red button on THE REMOTE REMOTE!",
      "Your old remote beeps until you find it!",
      "\"But what if I lose the Remote Remote?\"",
      "That's what the REMOTE REMOTE REMOTE is for!",
      "COLLECT ALL NINE!"
    ],
    fine: "Remotes sold separately. Beeping may continue after remote is found."
  },
  {
    id: "indoor-mud",
    kind: "toy",
    product: "INDOOR MUD",
    tagline: "All the mud. None of the outside.",
    palette: ["#4E2A1E", "#8AE65E"],
    lines: [
      "MOM SAYS IT'S RAINING?",
      "MOM SAYS IT'S TOO DARK?",
      "MOM CAN'T STOP THIS.",
      "INDOOR MUD! Real mud texture! Carpet-safe*!",
      "Squish it! Stack it! Explain it to your parents!",
      "INDOOR MUD. It's mud. It's indoors."
    ],
    fine: "*Carpet-safe claim under review. Mom was consulted and has concerns."
  },
  {
    id: "pillow-pillow",
    kind: "gadget",
    product: "PILLOW FOR YOUR PILLOW",
    tagline: "Because your pillow deserves rest too.",
    palette: ["#3D2B5E", "#FFB6D5"],
    lines: [
      "Your pillow works HARD. All night. Every night.",
      "Where does YOUR pillow lay its head?",
      "Introducing the PILLOW FOR YOUR PILLOW.",
      "Softness, squared.",
      "Your pillow will notice. Your pillow will thank you.",
      "PILLOW FOR YOUR PILLOW. It goes under the pillow."
    ],
    fine: "Do not stack more than 11 units. Pillows cannot actually feel gratitude. Probably."
  },
  {
    id: "yellos",
    kind: "cereal",
    product: "YELL-O's",
    tagline: "The cereal that yells back!",
    palette: ["#C22B2B", "#FFE45E"],
    lines: [
      "Tired of QUIET breakfast?",
      "NEW YELL-O's! Each O is packed with CRUNCH!",
      "Pour the milk and listen... (\"HEYYY!\")",
      "Part of a complete breakfast that never stops talking!",
      "Now with marshmallow exclamation points!",
      "YELL-O's! (\"WE'RE CEREAL!!\")"
    ],
    fine: "Cereal does not actually yell. The yelling is you. You're excited. That's the sugar."
  },
  {
    id: "karate-grandpa",
    kind: "toy",
    product: "KARATE GRANDPA",
    tagline: "The action figure with wisdom-chop action!",
    palette: ["#1E4E3D", "#FF8A3D"],
    lines: [
      "He's got a black belt AND hard candy!",
      "KARATE GRANDPA! With real napping action!",
      "Press his back for a wisdom chop: \"HI-YAH... back in my day!\"",
      "Comes with recliner dojo playset!",
      "Villains beware — he's been up since 4 AM!",
      "KARATE GRANDPA. Each sold separately from Bingo Sensei."
    ],
    fine: "Recliner dojo sold separately. Hard candy is decorative and permanently fused to hand."
  },
  {
    id: "soak-lord",
    kind: "toy",
    product: "SOAK LORD 3000",
    tagline: "The last water blaster you'll ever need. Legally.",
    palette: ["#0A3D6E", "#5EE6D0"],
    lines: [
      "THIS SUMMER... THE BACKYARD HAS A NEW RULER.",
      "SOAK LORD 3000! Triple-tank! Quad-nozzle! One purpose!",
      "Range: the neighbor's yard. The OTHER neighbor's yard.",
      "Pump it! Aim it! Apologize later!",
      "The garden hose called. It's retiring.",
      "SOAK LORD 3000. BOW BEFORE THE SPRAY."
    ],
    fine: "Adult supervision required. Soak Lord accepts no responsibility for lost alliances."
  },
  {
    id: "mortgage-game",
    kind: "game",
    product: "MORTGAGE! THE GAME",
    tagline: "The board game where everyone loses slowly!",
    palette: ["#3D3D4E", "#FFD24B"],
    lines: [
      "FAMILY GAME NIGHT JUST GOT REALISTIC.",
      "MORTGAGE! Roll the dice. Pay the bank. Feel something.",
      "Land on 'Escrow' — nobody knows what it means! That's the game!",
      "Draw a Surprise Repair card! It's the water heater! It's always the water heater!",
      "First player to age 65 wins!",
      "MORTGAGE! Fun for ages 30 and holding."
    ],
    fine: "Game may take 30 years to complete. No refinancing after the third snack break."
  },
  {
    id: "glow-worms",
    kind: "toy",
    product: "GLOW WORMS",
    tagline: "They're worms. That glow. That's it. That's the toy.",
    palette: ["#12103D", "#C1FF4A"],
    lines: [
      "Kids love worms. Kids love glowing.",
      "We asked: why not both?",
      "GLOW WORMS! Squishy! Luminous! Legless!",
      "Line them up! Pile them! Lose them under the couch where they glow accusingly!",
      "Over 40 worms in every bucket!",
      "GLOW WORMS. It was this or homework."
    ],
    fine: "Worms are not alive. Glow lasts 4 hours or one sleepover, whichever ends first."
  },
  {
    id: "trapper-jacket",
    kind: "school",
    product: "THE TRAPPER JACKET",
    tagline: "It's a jacket. It's a binder. It's back-to-school evolved.",
    palette: ["#4E1E3D", "#FF8A3D"],
    lines: [
      "This fall, don't just WEAR your look. FILE it.",
      "THE TRAPPER JACKET! Twelve pockets! Three ring binder spine!",
      "Homework in the left sleeve. Snacks in the right. Confidence everywhere.",
      "Velcro closure so loud, the whole class knows you came prepared.",
      "Available in Grape Crush, Asphalt, and Loud Teal.",
      "THE TRAPPER JACKET. Zip it. Clip it. Ace it."
    ],
    fine: "Do not machine wash with homework inside. We cannot stress this enough."
  },
  {
    id: "big-rays",
    kind: "local",
    product: "BIG RAY'S DISCOUNT AQUARIUM & TAX PREP",
    tagline: "Two great needs. One convenient Ray.",
    palette: ["#0E3D4E", "#FFE45E"],
    lines: [
      "Fish got you down? Taxes got you down-ER?",
      "Come see BIG RAY!",
      "Buy any tank over ten gallons, get a FREE 1040 consultation!",
      "\"Ray did my taxes while I picked out a pufferfish.\" — Actual customer",
      "Located between the highway and the other highway!",
      "BIG RAY'S! If Ray's not there, ask for Ray Jr.!"
    ],
    fine: "Ray is enrolled to practice before the IRS. The pufferfish is not."
  },
  {
    id: "crust-cutters",
    kind: "gadget",
    product: "CRUST CUTTERS PRO",
    tagline: "Professional-grade crust removal. For sandwiches.",
    palette: ["#8A4B2D", "#FFE45E"],
    lines: [
      "Regular knives leave crust SURVIVORS.",
      "CRUST CUTTERS PRO removes 100% of crust in ONE PRESS.",
      "Dinosaur shape! Star shape! Circle, for minimalists!",
      "Watch the crust fall away like your worries!",
      "Used by professional parents in over 40 states!",
      "CRUST CUTTERS PRO. Life's too short. So is lunch."
    ],
    fine: "Crust is a natural part of bread. Please compost your crust responsibly."
  },
  {
    id: "ladder-insurance",
    kind: "local",
    product: "LADDER INSURANCE",
    tagline: "Insurance. But specifically for ladders.",
    palette: ["#1E3D4E", "#B8E04A"],
    lines: [
      "You insure your car. You insure your home.",
      "But who's protecting... THE LADDER?",
      "Ladder theft. Ladder tipping. Ladder envy. It's all covered.",
      "\"I never thought it would happen to my ladder. Then it did.\"",
      "Ask about our step-stool starter plan!",
      "LADDER INSURANCE. Climb with confidence."
    ],
    fine: "Not affiliated with any real insurance product, ladder, or concept of risk."
  },
  {
    id: "santas-middle-manager",
    kind: "seasonal",
    season: "christmas",
    product: "SANTA'S MIDDLE MANAGER",
    tagline: "The holiday doll that keeps the workshop ON SCHEDULE.",
    palette: ["#8A1E2D", "#3F6B33"],
    lines: [
      "Santa gets the glory. But who runs the SPRINTS?",
      "SANTA'S MIDDLE MANAGER! With clipboard-clutch action!",
      "Pull the string: \"Let's circle back after the holidays!\"",
      "Comes with tiny laptop and expression of quiet determination!",
      "Elf performance reviews sold separately!",
      "SANTA'S MIDDLE MANAGER. Somebody has to say no to the elves."
    ],
    fine: "Doll cannot actually approve time off. Please stop asking the doll."
  },
  {
    id: "bubble-wrap-cologne",
    kind: "gadget",
    product: "POP! BUBBLE WRAP COLOGNE",
    tagline: "Smell like satisfaction.",
    palette: ["#2A2440", "#7ADFFF"],
    lines: [
      "What does JOY smell like?",
      "Plastic. Slightly. In a good way.",
      "POP! The world's first bubble-wrap-scented cologne.",
      "Top notes of packing tape. Base notes of a package arriving early.",
      "For him. For her. For anyone who's ever said 'ooh, bubble wrap.'",
      "POP! Wear the moment."
    ],
    fine: "Does not pop. We tried. The lab tried. It just doesn't."
  },
  {
    id: "yogurt-phone",
    kind: "gadget",
    product: "THE YOGURT PHONE",
    tagline: "It's a phone you keep in the fridge. Next to the yogurt.",
    palette: ["#F4E4C1", "#4E7AC7"],
    lines: [
      "Ever miss a call because you were AT THE FRIDGE?",
      "Never again.",
      "THE YOGURT PHONE. Mounts between the mustard and the leftovers.",
      "Crisp reception. Crisper drawer compatible.",
      "\"Now I take every call. Every single one. Even at 2 AM. From the fridge.\"",
      "THE YOGURT PHONE. Answer coolly."
    ],
    fine: "Not a yogurt. Not really a phone anymore either, by modern standards. It's a landline."
  },
  {
    id: "psa-mystery-hole",
    kind: "psa",
    product: "A MESSAGE FROM THE SAFETY COUNCIL",
    tagline: "Don't put your hand in the mystery hole.",
    palette: ["#0E2A1E", "#FFE45E"],
    lines: [
      "Hey kids. See a hole you can't identify?",
      "In a fence? In a wall? In the ground?",
      "You're wondering what's in there. We get it.",
      "DON'T PUT YOUR HAND IN THE MYSTERY HOLE.",
      "Tell an adult. Adults love identifying holes.",
      "The more you know, the fewer holes you touch."
    ],
    fine: "Brought to you by the Council for Not Touching Stuff. Est. whenever."
  },
  {
    id: "psa-reading",
    kind: "psa",
    product: "A MESSAGE ABOUT READING",
    tagline: "Reading: it's like TV in your head.",
    palette: ["#3D2B5E", "#FFD24B"],
    lines: [
      "Did you know books work WITHOUT electricity?",
      "No commercials. No reruns. No 'please stand by.'",
      "The pictures? You make those. In your HEAD.",
      "The special effects budget is unlimited up there.",
      "Grab a book. Any book. Even the one about boats.",
      "READING. Now in your imagination, forever."
    ],
    fine: "This message paid for by the Channel 27 legal department, who suggest you also keep watching Channel 27."
  },
  {
    id: "psa-stretch",
    kind: "psa",
    product: "A MESSAGE ABOUT STRETCHING",
    tagline: "You've been sitting a while. We can tell.",
    palette: ["#1E4E3D", "#8AE6C1"],
    lines: [
      "Hey. You. On the couch.",
      "When's the last time you stood up?",
      "That's what we thought.",
      "Stand up. Reach for the ceiling. You won't reach it. That's okay.",
      "Roll those shoulders. Nice.",
      "Okay, sit back down. The show's coming back."
    ],
    fine: "Channel 27 is not a licensed physical therapist. Channel 27 is a television station."
  },
  {
    id: "spooky-flakes",
    kind: "seasonal",
    season: "halloween",
    product: "SPOOKY FLAKES",
    tagline: "The cereal that's afraid of the milk!",
    palette: ["#2A0A3D", "#FF8A3D"],
    lines: [
      "This Halloween... breakfast gets HAUNTED.",
      "SPOOKY FLAKES! Each flake shaped like a tiny ghost!",
      "Pour the milk and hear them go 'oooOOOooo' (that's the crackle)!",
      "Turns your milk gray! On purpose! It's a feature!",
      "With marshmallow bats, cauldrons, and one tiny mummy per box!",
      "SPOOKY FLAKES. Part of this boo-tiful breakfast."
    ],
    fine: "Gray milk is normal. The tiny mummy is a choking hazard and a collector's item."
  },
  {
    id: "hose-organizer",
    kind: "infomercial",
    product: "THE HOSE BOSS",
    tagline: "Are you tired of your garden hose? Of course you are.",
    palette: ["#0D3B2E", "#FFE45E"],
    lines: [
      "The average American wrestles their hose 340 times a year.*",
      "Those days are OVER.",
      "THE HOSE BOSS coils your hose with the push of a lever!",
      "No tangles! No kinks! No shame!",
      "Order in the next ten minutes and get a SECOND lever!",
      "THE HOSE BOSS. Show that hose who's boss. (It's you.)"
    ],
    fine: "*Statistic invented for this commercial. Second lever attaches to nothing."
  },
  {
    id: "snackle-box",
    kind: "food",
    product: "SNACKLE BOX",
    tagline: "A tackle box. For snacks. You're welcome.",
    palette: ["#8A4B2D", "#5EE6D0"],
    lines: [
      "Fishermen figured out compartments YEARS ago.",
      "It's time snackers caught up.",
      "SNACKLE BOX! Eighteen compartments of pure possibility!",
      "Crackers here. Cheese cubes there. Gummy worms in the worm slot, obviously.",
      "Take it to the game! The lake! The couch, mostly the couch!",
      "SNACKLE BOX. Organize your hunger."
    ],
    fine: "Do not store actual fishing lures with snacks. Again: do not. We have letters."
  },
  {
    id: "channel27-store",
    kind: "local",
    product: "THE CHANNEL 27 GIFT SHOP",
    tagline: "Yes, we have a gift shop. No, we don't know why.",
    palette: ["#1D1160", "#FFC24B"],
    lines: [
      "Love Channel 27? Prove it. With merchandise.",
      "T-shirts! Mugs! A foam antenna hat that gets terrible reception!",
      "The official Doppler Dan umbrella — opens jazzily!",
      "Every purchase keeps us on the air. Mostly the mugs.",
      "Located in the lobby, next to the vending machine that hums.",
